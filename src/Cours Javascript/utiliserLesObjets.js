...
const monObjet = { person: { prenom: "Jean", nom: "Castex" }, job: "Politicien" };
// person et job sont des "keys" et ce qui se trouve à droite de ces keys sont leurs valeurs
...
const lePrenom = monObjet.person.prenom; // => "Jean"
...
const { person, job } = monObjet;
console.log(person); // => { prenom: "Jean", nom: "Castex" }
...
const objetComplexe1 = { person: { prenom: "Jean", nom: "Castex" }, job: "Politicien" };
const copieObjetComplexe1 = { ...objetComplexe1 };

copieObjetComplexe1.person.nom = "Castsaphiore";

console.log(objetComplexe1); // => { person: { prenom: 'Jean', nom: 'Castsaphiore' }, job: 'Politicien' }
console.log(copieObjetComplexe1); // => { person: { prenom: 'Jean', nom: 'Castsaphiore' }, job: 'Politicien' }
...
const objetComplexe2 = { person: { prenom: "Jean", nom: "Castex" }, job: "Politicien" };
const copieObjetComplexe2 = JSON.parse(JSON.stringify(objetComplexe2));

copieObjetComplexe2.person.nom = "Castsaphiore";

console.log(objetComplexe2); // => { person: { prenom: 'Jean', nom: 'Castex' }, job: 'Politicien' }
console.log(copieObjetComplexe2); // => { person: { prenom: 'Jean', nom: 'Castsaphiore' }, job: 'Politicien' }
